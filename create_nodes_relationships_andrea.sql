...
-------SYNONYM
\copy (SELECT 's'||id as synonym_id,label,'Synonym' as label FROM public.synonym where type not ilike 'related' and type not ilike 'raw') TO '../neo4j-community-3.4.1/import/gcm_entities/synonym.csv' WITH (DELIMITER '+', FORMAT CSV, FORCE_QUOTE (label));
