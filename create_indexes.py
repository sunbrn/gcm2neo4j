...
donor_index = "CREATE INDEX ON :Donor(source_id)"
tx.append(donor_index)
tx.commit()

biosample_index = "CREATE INDEX ON :Biosample(source_id)"
tx.append(biosample_index)
tx.commit()

replicate_index = "CREATE INDEX ON :Replicate(source_id)"
tx.append(replicate_index)
tx.commit()

item_index = "CREATE INDEX ON :Item(source_id)"
tx.append(item_index)
tx.commit()

case_index = "CREATE INDEX ON :Case(source_id)"
